    ...
    <header class="app-header">
        <div class="container header-content">
            ...
            <nav class="main-nav" id="mainNav">
                ...
                <a href="/partner-contracts" class="nav-link ${(window.location.pathname.includes('partner-contracts') || window.location.pathname.includes('halomanage-partnerships')) ? 'active' : ''}"><i class="fas fa-handshake"></i><span>Partner Contracts</span></a>
