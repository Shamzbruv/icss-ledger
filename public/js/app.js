...
window.submitStatusUpdate = async function () {
    ...
    try {
        ...
        const res = await apiFetch('/api/invoices/resend', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                invoiceId: id,
...
async function fetchPreviewState() {
    ...
    try {
        ...
        // 4. API Call
        const res = await apiFetch('/api/invoices/preview-state', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
window.resendInvoiceEmail = async function (id) {
    ...
    try {
        ...
        const res = await apiFetch('/api/invoices/resend-email-only', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
