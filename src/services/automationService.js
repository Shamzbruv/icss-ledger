...
async function sendPaymentReceipt(invoiceId) {
    ...
    try {
        ...
        // 6. Send Email
        // BCC is sourced from EMAIL_AUDIT_BCC env var inside emailService — no hardcoded address here.
        ...
        await sendInvoiceEmail(
            ...
            emailContent.html,
            pdfBuffer,
            invoice.invoice_number, // bare filename; sendInvoiceEmail appends .pdf
            null // BCC applied from EMAIL_AUDIT_BCC inside emailService
        );
