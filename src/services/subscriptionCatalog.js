const WEBSITE_PLAN_CATALOG = {
    ...
    'P-3ME55562GX964564ENECRUBA': { code: 'MONITOR', name: 'App Monitoring', legacyNames: [], price: 150, careFrequency: 'monthly', features: [] },
    'P-7347581535896321PNECRW6A': { code: 'GD', name: 'Graphic Design', legacyNames: [], price: 80, careFrequency: 'monthly', features: [] },
    'P-1PR36418LS475621RNECRZJY': { code: 'AUTO_BIZ', name: 'Business Automation', legacyNames: [], price: 120, careFrequency: 'monthly', features: [] },
    'P-5CM47756734472516NECR24Q': { code: 'AUTO_IND', name: 'Industry Automation', legacyNames: [], price: 250, careFrequency: 'monthly', features: [] },
    'P-5U310187T43711805NIVMAJQ': { code: 'EMAIL', name: 'Expand Email Plan', legacyNames: [], price: 63, careFrequency: 'yearly', features: [] }
};
