...
<head>
  ...
  <meta property="og:url" content="https://icreatesolutionsandservices.com/${p.filename}">
  <meta property="og:title" content="${p.title}">
  <meta property="og:description" content="${p.description}">
  <meta property="og:image" content="https://i.postimg.cc/ZKJvnxxH/Untitled-design.png">
  <link rel="canonical" href="https://icreatesolutionsandservices.com/${p.filename}">
...
<body class="bg-gray-900 text-white font-sans antialiased min-h-screen flex flex-col">
  ...
  <section class="hero-bg py-24 digital-static relative overflow-hidden">
    <div class="container mx-auto px-6 text-center relative z-10">
      <h1 class="text-4xl md:text-6xl font-bold mb-6 text-white tracking-tight">${p.h1}</h1>
      <p class="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">${p.description}</p>
    ...
    <div class="container mx-auto px-6 max-w-3xl">
      <div class="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 p-8 md:p-12 rounded-2xl shadow-2xl">
        ...
        <form id="landing-contact-form" class="space-y-4">
          ...
          <input type="hidden" id="ld-service" value="${p.service_val}">
...
const outDir = path.join(__dirname, 'main website file');
for (const p of PAGES) {
    const html = generateHtml(p);
    fs.writeFileSync(path.join(outDir, p.filename), html, 'utf8');
